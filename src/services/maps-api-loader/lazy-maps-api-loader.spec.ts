...
import {MapsScriptProtocol, LAZY_MAPS_API_CONFIG, LazyMapsAPILoader, LazyMapsAPILoaderConfigLiteral} from './lazy-maps-api-loader';
...
describe('Service: LazyMapsAPILoader', () => {
  ...
  it('should load the script via http when provided', () => {
    const lazyLoadingConf:
        LazyMapsAPILoaderConfigLiteral = {protocol: MapsScriptProtocol.HTTP};
